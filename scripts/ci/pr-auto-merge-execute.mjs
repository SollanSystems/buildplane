...
export async function main() {
	// RETIRED: auto-merge is owned by Mergify via .mergify.yml merge_protections.
	// The merge path is intentionally removed so this executor cannot race
	// Mergify. The exported helpers above remain available for reuse and tests;
	// running this script directly no longer merges anything.
	process.stderr.write(
		"pr-auto-merge-execute is retired: auto-merge is owned by Mergify " +
			"(.mergify.yml). Refusing to merge.\n",
	);
	process.exit(1);
}
