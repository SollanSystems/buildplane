		...
		try {
			...
			writeFileSync(
				...
				[
					...
					'writeFileSync(join(process.cwd(), "packages", "adapters-models", "tsconfig.tsbuildinfo"), "{}\\n");',
					'writeFileSync(join(process.cwd(), "packages", "adapters-tools", "tsconfig.tsbuildinfo"), "{}\\n");',
			...
			expect(
				...
				"packages/adapters-models/dist",
				"packages/adapters-models/tsconfig.tsbuildinfo",
				"packages/adapters-tools/dist",
				"packages/adapters-tools/tsconfig.tsbuildinfo",
